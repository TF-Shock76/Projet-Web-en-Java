...
public class GetRechercheTheme extends HttpServlet 
{
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException 
    {
		try 
		{
		    ...
		    ResultSet rs = st.executeQuery("select * from Theme order by idTheme");
		    ...
		    RequestDispatcher rd = request.getRequestDispatcher("/recherche_theme.jsp");
